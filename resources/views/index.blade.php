                        ...
                        <div class="post__content">
                            ...
                            <div class="post__content-info">
                                    ...
                                    <h2 class="post__title entry-title text-center">
                                        <a href="{{ route('post.single',['slug'=>$first_post->slug]) }}">{{ $first_post->title }}t</a>
                                    </h2>
                                    ...
                                    <div class="post-additional-info">
                                        ...
                                        <span class="category">
                                            ...
                                            <a href="{{ route('category.single',['id'=> $first_post->id]) }}">{{ $first_post->category->name }}</a>
                                        </span>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">Development</h4>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach($development->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">Mobile Development</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach($mobileDevelopment->posts()->orderBy('created_at','desc')->take(3)->get() as $post)
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{ $post->featured }}" alt="our case">
    ...
    <div class="container">
        <div class="row">
            <div class="form_search-wrap">
                <form action="/results">
                    <input name="query" class="overlay_search-input" placeholder="Type and hit Enter..." type="text">
